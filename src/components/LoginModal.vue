...
<template>
    <div class="d-flex flex-column" id="text-box">
        <svg
  ...
  >
    ...
    />
        ...
        <form  id="login">
            ...
            <div for="emailInput"><span for="emailInput">→</span><input type="email" autofocus="true" id="emailInput" class="input-group" >
       
            </div>
            <label for="passInput" style="display: block; color:#00cfc8; font-size: 16px; font-weight: 600;" >Enter your password</label>
...
.text
    ...
    height: 0px
.text1
    animation: texttype 2s steps(40, end) forwards,blink-caret .2s step-end 10
.text2
    animation: texttype 2s steps(40, end) 2s forwards,blink-caret .2s step-end 2s 10
#login
    margin: 0px
    width: 0px
    height: 0px
    visibility: hidden
    animation: display 0s forwards 4.2s
    >div
        margin-bottom: 20px
        display: flex
        align-items: center
